...
/**
 * shash_table_t *shash_table_create - creates a hash table
...
/**
 * shash_table_set - adds an element in a sorted linked list
 * of the hash table at the right place
 * @ht: the hash table
...
/**
 * insert_sort - inserts a node in a doubly linked_list
 * @node: the node to be inserted
 * @ht: pointer to the hash table to inser into
 */
